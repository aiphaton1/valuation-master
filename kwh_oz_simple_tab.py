...
def render_kwh_oz_simple_tab():
    ...
    st.markdown(
        "**Translate grade into energy intensity per payable ounce. Add recovery and electricity kWh/t inputs "
        "when available to refine the estimate. Heuristic ranges: heap leach 6–12 kWh/t • conventional mill "
        "20–35 • hard/fine grind 35–60+.**"
    )
